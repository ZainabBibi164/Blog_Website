...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-b)mb4x*=g3z*x1423k%d7dx87a8+h0uflr47+3fththjte+3gb')
...
# Use DATABASE_URL when provided (Railway Postgres). Falls back to sqlite.
